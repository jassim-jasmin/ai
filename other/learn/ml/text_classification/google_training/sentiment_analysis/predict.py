...
def predict(val_texts):
    # vectorizer = get_vectorizer()
    vectorizer = pickle.load(open('/other/learn/ml/text_classification/google_training/sentiment_analysis/vector.pkl', 'rb'))
    x_val = vectorizer.transform(val_texts)
    selector = pickle.load(open('/other/learn/ml/text_classification/google_training/sentiment_analysis/feature.pkl', 'rb'))
